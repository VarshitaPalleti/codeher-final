...
export default function Hero17({ chip, headLine, captionLine, primaryBtn, videoSrc, videoThumbnail, listData }) {
  ...
  return (
    <>
    <img src='\assets\images\image (1).png' id="goddess-image"/>
    <img src='\assets\images\image (1).png' id="goddess-image-2"/>
      <Box
        sx={{
        ...
        <Box ref={containerRef}>
          <Box sx={{ pb: { xs: 3, sm: 4, md: 5 } }}>
            <Stack sx={{ alignItems: 'center', gap: 1.5 }}>
              ...
              >
                <Typography variant="h6" align="center" sx={{ color: 'text.background', maxWidth: 650 }}>
                  {captionLine}
                </Typography>
              </motion.div>
            </Stack>

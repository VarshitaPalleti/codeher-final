...
export const pagesMegamenu = {
  ...
  megaMenu: {
    ...
    toggleBtn: { children: 'Oppurtunities' },
    popperWidth: 860,
    menuItems: [
      {
        title: 'General',
      ...
      },
      {
        ...
        itemsList: [
          { title: 'Coming Soon', status: 'Updating' },
          { title: 'Domains', link: { href: PRIVIEW_PATH.error404, ...linkProps } },
          { title: 'Learnings', link: { href: PRIVIEW_PATH.error500, ...linkProps } },
          { title: 'Others', status: 'Pro' }
        ]
      },
      {
        title: 'Others',

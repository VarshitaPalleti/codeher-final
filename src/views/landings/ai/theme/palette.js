...
export default function palette() {
  const textPrimary = '#510706'; // AI/neutral/10 - on surface
  const textSecondary = '#510706'; // AI/neutral variant/30 - on surface variant
  const divider = '#C2C7CE'; // AI/neutral variant/80 - outline variant
  const background = '#FFF';

  const lightPalette = {
    primary: {
      lighter: '#F0E0C1', // AI/primary/90 - primary container / primary fixed
      light: '#92CCFF', // AI/primary/80 - primary fixed dim
      main: '#510706', // AI/primary/40 - primary
    ...
    secondary: {
      ...
      main: '#F0E0C1', // AI/secondary/40 - secondary
